...
点积还可以求投影。$\mathbf a$ 在 $\mathbf b$ 方向上的标量投影是
...
叉积 $\mathbf a\times\mathbf b$ 垂直于 $\mathbf a$ 和 $\mathbf b$，它的大小是
...
异面直线的最短距离沿着共同垂线方向。两个方向向量的叉积给出一个同时垂直于两条直线的方向。
