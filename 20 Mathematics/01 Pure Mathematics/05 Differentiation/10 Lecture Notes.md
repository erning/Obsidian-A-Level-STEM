...
This note develops [[20 Mathematics/01 Pure Mathematics/05 Differentiation/00 Overview|Differentiation]] as a self-study topic. Use it after the overview and before attempting the practice problems.
...
A useful self-check is to explain why this item belongs in Differentiation: what
...
1. Read the question and name the relevant concept from Differentiation.
