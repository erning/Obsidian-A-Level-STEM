...
如果 $\det A=0$，矩阵是 singular，不能求逆。几何上，变换把平面压扁到一条线或一个点，不能唯一反过来。
...
求特征值时解 characteristic equation：
...
Cayley-Hamilton theorem 说明方阵满足自己的 characteristic equation。对 $2\times2$ 和 $3\times3$ 矩阵，它可以用来求矩阵幂或逆矩阵。
