...
This note develops [[20 Mathematics/01 Pure Mathematics/04 Sequences Series and Binomial Expansions/00 Overview|Sequences, Series and Binomial Expansions]] as a self-study topic. Use it after the overview and before attempting the practice problems.
...
A useful self-check is to explain why this item belongs in Sequences, Series and Binomial Expansions: what
...
1. Read the question and name the relevant concept from Sequences, Series and Binomial Expansions.
