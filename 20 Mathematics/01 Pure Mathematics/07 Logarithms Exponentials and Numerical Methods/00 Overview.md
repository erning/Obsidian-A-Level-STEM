...
Logarithms and exponentials model inverse growth processes; numerical methods solve equations when algebra is not enough.
...
- Treat $\ln x$ and $e^x$ as inverse operations with domain restrictions.
- Use graphs to locate roots before iterating.
- Check a numerical root by substitution and by graph position.
...
- [[20 Mathematics/01 Pure Mathematics/07 Logarithms Exponentials and Numerical Methods/10 Lecture Notes|Lecture Notes]]
- [[20 Mathematics/01 Pure Mathematics/07 Logarithms Exponentials and Numerical Methods/10 Lecture Notes.zh-CN|中文讲义]]
- [[20 Mathematics/01 Pure Mathematics/07 Logarithms Exponentials and Numerical Methods/20 Worked Examples|Worked Examples]]
- [[20 Mathematics/01 Pure Mathematics/07 Logarithms Exponentials and Numerical Methods/30 Key Practice Problems|Key Practice Problems]]
- [[20 Mathematics/01 Pure Mathematics/07 Logarithms Exponentials and Numerical Methods/31 Key Practice Solutions|Key Practice Solutions]]
- [[20 Mathematics/01 Pure Mathematics/07 Logarithms Exponentials and Numerical Methods/80 Review Checklist|Review Checklist]]
