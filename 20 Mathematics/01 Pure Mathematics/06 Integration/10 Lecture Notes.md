...
This note develops [[20 Mathematics/01 Pure Mathematics/06 Integration/00 Overview|Integration]] as a self-study topic. Use it after the overview and before attempting the practice problems.
...
Integration is reverse differentiation, accumulated change, area, and a toolbox of transformations.
...
A useful self-check is to explain why this item belongs in Integration: what
...
- Decide whether the integral represents a function, an area, a volume, or a physical quantity.
- Differentiate the result to check indefinite integrals.
- Sketch the region before calculating definite areas.
...
1. Read the question and name the relevant concept from Integration.
