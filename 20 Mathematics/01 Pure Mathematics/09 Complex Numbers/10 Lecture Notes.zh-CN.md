...
如果继续用 $\sin^2\theta=1-\cos^2\theta$，就得到

$$
\cos3\theta=4\cos^3\theta-3\cos\theta.
$$

这类题的核心不是死记公式，而是把复数幂展开后比较实部或虚部。
...
$$
z=2e^{i(\pi+2k\pi)/4},\qquad k=0,1,2,3.
$$
...
它们都在 $|z|=2$ 的圆上，相邻根相差 $\frac{\pi}{2}$。求根题最后最好画一个小图检查根的数量和等间隔性。
...
设 $z=x+iy$。它表示点 $(x,y)$ 到 $(1,1)$ 和 $(3,0)$ 的距离相等，所以轨迹是这两个点连线的垂直平分线。
