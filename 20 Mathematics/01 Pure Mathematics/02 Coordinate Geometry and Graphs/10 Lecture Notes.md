...
This note develops [[20 Mathematics/01 Pure Mathematics/02 Coordinate Geometry and Graphs/00 Overview|Coordinate Geometry and Graphs]] as a self-study topic. Use it after the overview and before attempting the practice problems.
...
Coordinate geometry turns geometric relationships into algebraic equations and graph features.
...
A useful self-check is to explain why this item belongs in Coordinate Geometry and Graphs: what
...
### Circle equations in centre-radius and expanded forms
...
- Mark known points, gradients, centres, radii, and tangent relationships.
...
- Solve line-circle and graph-intersection problems.
- Sketch transformed graphs with domain and range.
...
1. Read the question and name the relevant concept from Coordinate Geometry and Graphs.
...
- Mixing gradient with angle.
- Forgetting tangent is perpendicular to radius at the point of contact.
- Expanding circle equations and losing the centre.
