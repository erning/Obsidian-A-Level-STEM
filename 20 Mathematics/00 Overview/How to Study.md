...
例如 completing the square 可以找 quadratic vertex；integration by parts 适合处理乘积；normal approximation 需要先判断模型和参数条件是否合理。
...
3. **关键方法**：步骤、条件和最小例子。
4. **连接**：它和前后主题、Physics 或 Statistics 的关系。
...
- 2 次 worked examples：手算教材例题，写出选方法的理由。
- 1 次主题整理：把公式、条件、图像和易错点写回 Obsidian。
- 1 次跨主题连接：把数学和 Physics、数据或旧主题连起来。
