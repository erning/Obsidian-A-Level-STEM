...
This note develops [[20 Mathematics/03 Probability and Statistics/03 Discrete Random Variables/00 Overview|Discrete Random Variables]] as a self-study topic. Use it after the overview and before attempting the practice problems.
...
A useful self-check is to explain why this item belongs in Discrete Random Variables: what
...
1. Read the question and name the relevant concept from Discrete Random Variables.
