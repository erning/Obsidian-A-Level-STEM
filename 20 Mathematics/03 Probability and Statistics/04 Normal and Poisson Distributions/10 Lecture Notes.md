...
This note develops [[20 Mathematics/03 Probability and Statistics/04 Normal and Poisson Distributions/00 Overview|Normal and Poisson Distributions]] as a self-study topic. Use it after the overview and before attempting the practice problems.
...
A useful self-check is to explain why this item belongs in Normal and Poisson Distributions: what
...
1. Read the question and name the relevant concept from Normal and Poisson Distributions.
