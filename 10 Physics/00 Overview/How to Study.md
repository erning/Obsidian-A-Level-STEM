...
例如学 kinematics 时，先问“怎样描述运动”；学 fields 时，先问“没有接触时为什么还能发生作用”。
...
例如 projectile motion 通常忽略空气阻力；ideal gas 忽略分子间相互作用；point charge 和 point mass 都是理想化。
...
- 可测量的量是什么？
- independent variable 和 dependent variable 是什么？
- 控制变量是什么？
- 最大误差来源是什么？
- 什么图像能验证这个关系？
...
- 2 次练习：以 worked examples 和基础题为主。
