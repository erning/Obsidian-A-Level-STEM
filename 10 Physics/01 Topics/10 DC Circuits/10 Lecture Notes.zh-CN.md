...
直流电路分析，本质上是把电荷守恒和能量守恒写成电路方程。Kirchhoff 第一定律管结点处电荷不能凭空增加或消失；Kirchhoff 第二定律管一圈回路中每库仑电荷获得的能量和失去的能量相等。串并联电阻、内阻、端电压、分压器和电位差计，都可以从这两条守恒规律出发理解。
...
端电压 $V$ 是电源两端、也就是外电路两端的电势差。若外电路只是电阻 $R$，则
...
如果外电阻远大于内阻，电流很小，$V$ 接近 $E$。如果外电阻很小，电流很大，端电压会明显下降。

实验测 $E$ 和 $r$ 时，可以改变外电阻，测端电压 $V$ 和电流 $I$。由
