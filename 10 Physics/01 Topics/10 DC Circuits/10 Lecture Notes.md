...
This note develops [[10 Physics/01 Topics/10 DC Circuits/00 Overview|D.C. Circuits]] as a self-study topic. Use it after the overview and before attempting the practice problems.
...
A useful self-check is to explain why this item belongs in D.C. Circuits: what
...
1. Read the question and name the relevant concept from D.C. Circuits.
