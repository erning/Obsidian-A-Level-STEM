...
This note develops [[10 Physics/01 Topics/23 Nuclear Physics/00 Overview|Nuclear Physics]] as a self-study topic. Use it after the overview and before attempting the practice problems.
...
A useful self-check is to explain why this item belongs in Nuclear Physics: what
...
1. Read the question and name the relevant concept from Nuclear Physics.
