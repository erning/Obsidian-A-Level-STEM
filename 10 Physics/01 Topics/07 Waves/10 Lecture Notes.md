...
This note develops [[10 Physics/01 Topics/07 Waves/00 Overview|Waves]] as a self-study topic. Use it after the overview and before attempting the practice problems.
...
A useful self-check is to explain why this item belongs in Waves: what
...
1. Read the question and name the relevant concept from Waves.
