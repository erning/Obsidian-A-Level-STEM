...
- 比较 uniform field 和 radial field。
- 判断正电荷、负电荷在电场中的受力和运动方向。
- 从 potential-distance graph 求 field strength。
- 处理带电粒子在平行板间的偏转。
- 对比 electric fields 和 gravitational fields 的相同点与不同点。

## 实验或观察连接

- 可以用 conducting paper 或电极模型绘制 equipotential lines。
- 带电粒子运动常以数据分析或图像题出现。
