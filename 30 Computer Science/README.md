---
title: CAIE Computer Science 9618
...
Topics are numbered to match the syllabus sections. Sections 1-12 are AS Level content, examined in Paper 1 (theory) and Paper 2 (problem-solving and programming). Sections 13-20 are A Level content, examined in Paper 3 (advanced theory) and Paper 4 (practical). Several A Level topics extend an AS topic with the same name: 13 Data Representation extends 1, 16 System Software extends 5, 19 Computational Thinking and Problem-solving extends 9.
