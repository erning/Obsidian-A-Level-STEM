...
Computing happens in a society. This topic covers the professional and legal responsibilities of people who build and use software, including copyright, licences, and the impact of artificial intelligence.

## Source Alignment

- 9618 AS section 7 Ethics and Ownership
...
- Professional bodies: BCS (British Computer Society), IEEE (Institute of Electrical and Electronic Engineers).
- Acting ethically versus unethically and the impact in a given situation.
- The need for copyright legislation.
- Software licences: Free Software Foundation, Open Source Initiative, shareware, and commercial software; justifying a licence for a given situation.
- Artificial Intelligence: its impact (social, economic, environmental) and its applications.
...
- Justify a software licence for a given project.
- Discuss the ethical impact of a computing decision.
- Describe the social, economic, and environmental impact of an AI application.
...
- Confusing open source with shareware.
- Treating "ethical" as merely "legal".
- Listing AI applications without considering their impact.
